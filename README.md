...
如果你是毫无经验的小白，搭建 V2Ray 请看此教程：V2Ray 一键搭建和优化详细图文教程
如果你需要在谷歌云搭建 V2Ray 请看此教程：谷歌云一键搭建 V2Ray 详细图文教程
...
友情提示
真是无聊，折腾啥啊。如果你担心 IP 被墙，推荐买个 Just My Socks 先凑合用着就可以了，被墙自动换 IP，无须担心 IP 被墙！Just My Socks 是搬瓦工出品的代理服务，质量可靠，优质 CN2 GIA 线路，同时支持退款，放心无忧。
